...
## Project Structure
    ...
    ├── xscapes_transportat_33517  # Django project configurations
...
1. Clone this repo and `cd xscapes_transportat_33517`
...
2. Clone this repo and `cd xscapes_transportat_33517`
